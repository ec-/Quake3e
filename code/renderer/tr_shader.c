...
void R_UpdateShaderColorByHandle(qhandle_t hShader, const vec3_t color)
{
	...
	shader_l->stages[0]->constantColor.rgba[0] = color[0] * 255;
	shader_l->stages[0]->constantColor.rgba[1] = color[1] * 255;
	shader_l->stages[0]->constantColor.rgba[2] = color[2] * 255;
	shader_l->stages[0]->constantColor.rgba[3] = 255;
}
